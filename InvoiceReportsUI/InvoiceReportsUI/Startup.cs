...
namespace InvoiceReportsUI
{
  ...
  //          services.AddDbContext<InvoiceReportContext>(options =>
  ...
  //);
            ...
            //{
            //    c.SwaggerDoc("v1", new Info { Title = "InvoiceReportsUI API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            //app.UseSwaggerUI(c =>
            //{
            //    c.SwaggerEndpoint("/swagger/v1/swagger.json", "InvoiceReportsUI API V1");
            //});
